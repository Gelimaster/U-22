...
<html>
  ...
  <body>
    ...
    <div class="nav">
      ...
      <ul>
        <li><a id="stage1" onmouseover="select()" onmouseleave="unselected()" href="/quest1.php" class="button">1-1</a></li>
        <li><a id="stage2" onmouseover="select()" onmouseleave="unselected()" href="/quest1.php" class="button">1-2</a></li>
        <li><a id="stage3" onmouseover="select()" onmouseleave="unselected()" href="/quest1.php" class="button">1-3</a></li>
    ...
    <div class="village">
      ...
      <div id="quest1" class="q1">
        <a href="/quest1.php">
          ...
          <img src="/images/quest/house2.png" alt="house2" class="house2" />
        </a>
      </div>
    </div>
