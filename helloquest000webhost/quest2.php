...
<html>
  ...
  <body>
    ...
    <div class="nav">
      ...
      <ul>
        <li><a id="stage1" onmouseover="select(this)" onmouseleave="unselected()" href="/quest.php" class="button">2-1</a></li>
        <li><a id="stage2" onmouseover="select(this)" onmouseleave="unselected()" href="/quest.php" class="button">2-2</a></li>
      </ul>
