...
<body>
  ...
  <div class="nav">
    ...
    <ul>
      <li><a id="stage1" onclick="set(this)" onmouseover="select()" onmouseleave="unselected()" href="/quest.php" class="button">3-1</a></li>
    </ul>
  ...
  <div class="village">
    ...
    <div id="quest3" onmouseover="select()" onmouseleave="unselected()" class="q3">
      <a href="/quest.php">
